...
export default function Home() {
  const previewArticles = useMemo(() => {
    // 優先顯示夏季旅展與沖繩相關文章 (article-tte-2026, okinawa-typhoon-guide, article-3, article-7, okinawa-family-churaumi-dino)
    const priorityIds = ['article-tte-2026', 'okinawa-typhoon-guide', 'article-3', 'article-7', 'okinawa-family-churaumi-dino'];
