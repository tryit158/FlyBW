...
export default function Home() {
  const previewArticles = useMemo(() => {
    // 優先顯示 2026 暑期大盤走勢、日本退稅新制、日本交通卡指南、夏季旅展、沖繩與上網卡相關文章 (summer-travel-trends-2026, japan-tax-free-2026, japan-suica-card-guide-2026, article-tte-2026, esim-usage-guide, okinawa-typhoon-guide, article-3, article-7, okinawa-family-churaumi-dino)
    const priorityIds = ['summer-travel-trends-2026', 'japan-tax-free-2026', 'japan-suica-card-guide-2026', 'article-tte-2026', 'esim-usage-guide', 'okinawa-typhoon-guide', 'article-3', 'article-7', 'okinawa-family-churaumi-dino'];
